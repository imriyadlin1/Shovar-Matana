...
export function BottomNav({ email }: NavSession) {
  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-lg items-stretch justify-between gap-0.5 px-1">
        ...
        <Item href="/messages" icon={<MessageSquare className="size-[1.35rem]" strokeWidth={2} />} label="צ׳אט" />
        <Item href="/dashboard" icon={<Building2 className="size-[1.35rem]" strokeWidth={2} />} label="שוברים" />
